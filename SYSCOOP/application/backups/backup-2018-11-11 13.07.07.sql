...
INSERT INTO `agricultores` (`id`, `nome`, `cpf`, `telefone`, `email`, `uf`, `cep`, `cidade`, `endereco`, `dapNumero`, `dapValidade`, `status`, `dapLimite`) VALUES (1, 'ADAIR JOSE RONSONI', '284.474.040-56', '54999558877', 'adair@gmail.com', 'rs', '99732001', 'erechim', 'rua louro martes', NULL, NULL, 'inativo', '192');
INSERT INTO `agricultores` (`id`, `nome`, `cpf`, `telefone`, `email`, `uf`, `cep`, `cidade`, `endereco`, `dapNumero`, `dapValidade`, `status`, `dapLimite`) VALUES (2, 'ZzUMILDA ANA BONATTO', '372.623.290-73', '54992141578', 'zbonatto@yahoo.com', 'rs', '99660555', 'erechim', 'rua sergipe', 'RS43070050301195900001067', '2018-11-15', 'ativo', '0');
